...
export const PARTS = [
  ...
  { id:'PinchGuard', mesh:'bench-imu-01-pinch-guard-quadrant.obj', quadrant:4,
    ...
    role:'Partial mitigation for the flywheel-bay pinch hazard (REQ-407(b)). All 4 quadrants are geometrically identical (confirmed by direct module inspection, ECO-032).',
  ...
  { id:'BaseAssembly', mesh:'bench-imu-01-base-assembly.obj',
    ...
    dims:'123 × 168 × 51mm bounding box (combined single print)',
  ...
  { id:'PcbLid', mesh:'bench-imu-01-pcb-lid.obj',
    ...
    name:'PCB Lid', ref:'—',
    dims:'111.4 × 69.8 × 5mm',
    role:'PCB retention lid — closes over the PCB bay. Secured with 4× M2.5 self-tap screws into the base assembly\'s corner tabs.',
