...
export const PARTS = [
  ...
  { id:'PinchGuard', mesh:'bench-imu-01-pinch-guard-quadrant.obj', quadrant:4,
    category:'print3d', y:0,
    name:'Pinch Guard (×4 quadrants)', ref:'—',
    dims:'115mm outer radius ring, 4× identical 90° quadrants',
    role:'Partial mitigation for the flywheel-bay pinch hazard (REQ-407(b)). All 4 quadrants are geometrically identical (confirmed by direct module inspection, ECO-032). REV 5: coverage vs. the rotating hazard band dropped from ~77.7% to ~35.0% as a side effect of the Bench-IMU-01 board resize (MISS-034) growing the rotating envelope — MISS-023 re-opened pending fresh human review (validation/open-issues.md). Also: a real, pre-existing quadrant-cutting geometry bug (MISS-036, unrelated to the resize) was found and fixed this pass — this mesh now has the correct, full-intended material for the first time (was ~35% short).',
    source:'3D-printed, PETG (assumption). STL: bench-imu-01-pinch-guard-quadrant.stl' },
  { id:'StandPlate', mesh:'bench-imu-01-stand-plate.obj',
  ...
  { id:'BaseAssembly', mesh:'bench-imu-01-base-assembly.obj',
  ...
  { id:'PcbLid', mesh:'bench-imu-01-pcb-lid.obj',
  ...
  { id:'ContainmentCap', mesh:'bench-imu-01-containment-cap.obj',
